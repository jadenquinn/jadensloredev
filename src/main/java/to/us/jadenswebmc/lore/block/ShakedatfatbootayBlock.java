...
public class ShakedatfatbootayBlock extends ModJadensloreModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.LAVA).sound(SoundType.CLOTH).hardnessAndResistance(1.5f, 16f).setLightLevel(s -> 0)
					.slipperiness(0.2f));
			setRegistryName("shakedatfatbootay");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("This is a crafting material for something better"));
		}
