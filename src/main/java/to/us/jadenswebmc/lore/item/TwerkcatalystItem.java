...
public class TwerkcatalystItem extends JadensloreModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(JlctItemGroup.tab).maxDamage(64).rarity(Rarity.UNCOMMON));
			setRegistryName("twerkcatalyst");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Crafting Material"));
		}
	}
}
