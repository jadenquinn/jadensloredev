...
import to.us.jadenswebmc.lore.procedures.SackerswordRightClickedOnBlockProcedure;
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("The power of Andre is with you..."));
			}
			...
			public ActionResultType onItemUse(ItemUseContext context) {
				...
				ItemStack itemstack = context.getItem();
				{
					...
					SackerswordRightClickedOnBlockProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
			...
			public boolean hitEntity(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
				...
				World world = entity.world;
				{
					...
					$_dependencies.put("z", z);
					$_dependencies.put("world", world);
					SackerswordLivingEntityIsHitWithToolProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
			...
			public boolean onEntitySwing(ItemStack itemstack, LivingEntity entity) {
				...
				World world = entity.world;
				{
					...
					$_dependencies.put("z", z);
					$_dependencies.put("world", world);
					SackerswordEntitySwingsItemProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
		...
		}.setRegistryName("sackersword"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(JlctItemGroup.tab).maxDamage(16384));
		}
